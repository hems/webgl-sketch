...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = new ((function() {
	  ...
	  _Class.prototype.set_tests = function(tests) {
	    var supportsWebGL, test, _i, _len, _results;
	    _results = [];
	      ...
	      switch (test) {
	        case 'desktop':
	          if (!this.detect.tablet() || !this.detect.mobile()) {
	            _results.push(this.tests['desktop'] = true);
	          } else {
	            _results.push(this.tests['desktop'] = false);
	          }
	          break;
	        case 'tablet':
	          _results.push(this.tests['tablet'] = this.detect.tablet());
	          break;
	        case 'mobile':
	          _results.push(this.tests['mobile'] = this.detect.mobile());
	          break;
	        case 'AudioContext':
	          _results.push(this.tests['AudioContext'] = window.AudioContext || window.webkitAudioContext);
	          break;
	        case 'WebGL':
	          ...
	          _results.push(this.tests['WebGL'] = supportsWebGL());
	          break;
	        case 'mp3':
	          _results.push(this.tests['mp3'] = Modernizr.audio.mp3);
	          break;
	        case 'ogg':
	          _results.push(this.tests['ogg'] = Modernizr.audio.ogg);
	          break;
	        default:
	  ...
	  _Class.prototype.supported = function() {
	    var result, supported, test, _ref, _ref1;
	    result = false;
	    this.fails = [];
	    _ref = this.tests;
	    for (test in _ref) {
	      supported = _ref[test];
	      if (!supported) {
	        this.fails.push(this.messages[test]);
	      }
	    }
	    if (this.fails.length < 1) {
	      result = true;
	    }
	    _ref1 = this.tests;
	    for (test in _ref1) {
	      supported = _ref1[test];
	      if (supported === false) {
	        result = false;
	        break;
	      }
	  ...
	  _Class.prototype.unsupported = function() {
	    var locals, template;
	    ...
	    return $('body').append(template(locals));
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index, RAF, View, cameras, controls, gui, happens, renderer, scene, settings, win,
	  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

	settings = __webpack_require__(1);

	cameras = __webpack_require__(8);

	scene = __webpack_require__(9);

	renderer = __webpack_require__(10);

	controls = __webpack_require__(11);

	gui = __webpack_require__(5);

	win = __webpack_require__(6);

	RAF = __webpack_require__(7);

	happens = __webpack_require__(13);

	View = __webpack_require__(12);

	module.exports = new (Index = (function() {
	  Index.prototype.game = null;
	  ...
	  Index.prototype._bind = function() {
	    ...
	    return RAF.on('tick', this._update);
	  };

	  Index.prototype._update = function() {
	    controls.update();
	    if (settings.debug) {
	      return this._render(cameras.dev, 0, 0, 1, 1);
	    } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div id=\"upgrade\">Upgrade your browser for the best experience<br/>Missing features:");
	// iterate locals.fails
	;(function(){
	  var $$obj = locals.fails;
	  if ('number' == typeof $$obj.length) {

	    for (var $index = 0, $$l = $$obj.length; $index < $$l; $index++) {
	      var fail = $$obj[$index];

	buf.push("<span>" + (jade.escape((jade_interp = fail) == null ? '' : jade_interp)) + "</span>");
	    }

	  } else {
	    var $$l = 0;
	    for (var $index in $$obj) {
	      $$l++;      var fail = $$obj[$index];
